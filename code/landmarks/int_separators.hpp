 ...
 */
[[nodiscard]] auto get_lmcut_violated_landmarks(const hplus::execution& exec, const hplus::instance& inst, const std::vector<double>& xstar)
...
/// solution
[[nodiscard]]
auto get_comp_violated_landmark(const hplus::execution& exec, const hplus::instance& inst, const std::vector<unsigned int>& unreachable_actions,
...
[[nodiscard]]
auto get_front_violated_landmark(const hplus::execution& exec, const hplus::instance& inst, std::vector<unsigned int> unreachable_actions,
                                 const std::vector<unsigned int>& unused_actions, const BinarySet& reachable_state) -> std::vector<unsigned int>;
