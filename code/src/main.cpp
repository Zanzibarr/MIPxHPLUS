...
static void run(hplus::instance& inst, hplus::environment& env, hplus::statistics& stats, const logger& log) {
    ...
    try {
        ...
        log.print_info("hmax: %u", static_cast<unsigned int>(find_hmax_goal(inst, log)));
